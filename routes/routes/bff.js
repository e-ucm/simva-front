    ...
    router.get('/activitytypes', auth, async (req, res, next) => {
        Simva.getActivityTypes(req.session.id, (error, result) => {
            if(error) {
                ...
                commun['download_title'] = req.t(`activity.download.title`, { ns : 'activities' } );
                commun['download_tooltip'] = req.t(`activity.download.tooltip`, { ns : 'activities' } );
                commun['edit_title'] = req.t(`activity.edit.title`, { ns : 'activities' } );
                commun['delete_title'] = req.t(`activity.delete.title`, { ns : 'activities' } );
