...
config.sso.adminPath=process.env.SSO_ADMIN_PATH || "/admin"
config.sso.consolePath=process.env.SSO_CONSOLE_PATH || "/console"
config.sso.adminUrl = `${config.sso.url}${config.sso.adminPath}/${config.sso.realm}${config.sso.consolePath}`
